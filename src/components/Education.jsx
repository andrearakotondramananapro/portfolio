    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl 3xl:max-w-7xl 4xl:max-w-8xl mx-auto px-6 sm:px-8 lg:px-12 3xl:px-16">
        ...
        <div className="relative">
          {/* Ligne verticale */}
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-sauge/30 md:-translate-x-1/2" />
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 md:left-1/2 w-10 h-10 -translate-x-1/2 z-10">
                    <div className="w-full h-full bg-sauge rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200">
                  ...
                  >
                    <div className="group bg-creme/90 backdrop-blur-sm p-8 rounded-2xl border border-gris/20 shadow-glass hover:shadow-glass-lg hover:border-sauge/20 hover:-translate-y-1 transition-all duration-200">
                      {/* Dates */}
