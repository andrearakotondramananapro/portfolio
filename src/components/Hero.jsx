      ...
      <div className="relative z-10 w-full max-w-7xl 3xl:max-w-8xl 4xl:max-w-9xl mx-auto px-6 sm:px-8 lg:px-12 3xl:px-16 py-24">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-24">
          ...
          <div className="relative group">
            ...
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-5 py-2.5 bg-creme/90 backdrop-blur-sm rounded-full shadow-glass border border-sauge/20">
          ...
          <div className="text-center lg:text-left max-w-xl">
            {/* Salutation */}
            <p className="text-lg md:text-xl text-sauge font-medium mb-3 tracking-wide">
              {t('hero.greeting')}
            </p>

            {/* Nom */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-charbon mb-5">
              {profile.name}
            </h1>

            {/* Titre */}
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-bordeaux mb-8">
              {t('hero.title')}
            </h2>

            {/* Sous-titre */}
            <p className="text-lg md:text-xl text-charbon/70 mb-10 leading-relaxed">
              {t('hero.subtitle')}
            </p>
